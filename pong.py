...
class GameObject:
    ...
    def collidesWith(self, other):
        ...
        return (abs(self.position[0] - other.position[0])  <= self.dimensions[0] + other.dimensions[0] and abs(self.position[1] - other.position[1])  <= self.dimensions[1] + other.dimensions[1])
...
class Ball(GameObject):
    ...
    def draw(self):
        ...
        pygame.draw.circle(self.game.window, GREEN, self.position, BALL_RADIUS)
    ...
    def update(self):
        ...
        if self.position[1] + BALL_RADIUS > HEIGHT:
            self.velocity[1] *= -1
